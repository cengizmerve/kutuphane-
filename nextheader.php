...
<div id="wrapper">
	<div id="container">
		...
		<div id="top">
			...
			<div id="labels">
				<ul>
					<li><a href="#" class="user"><span class="bar">Hoşgeldiniz, <?=$users["name"]?></span></a></li>
			...
			<div id="menu">
				<ul> 
					...
					<li>
						...
						<ul> 
							<li><a href="/uyesil">üye sil</a></li>
							<li><a href="/uyeler">kullanıcı profili görüntüle</a></li>
						</ul>
					</li>
					...
					<li>
						<a href="#">sorumlular</a>
						<ul> 
							<li><a href="/sorumlutanimlama">sorumlu tanımlama</a></li>
							<li><a href="/kitapekle">kitap giriş</a></li>
						</ul>
					</li>
					<li>
						<a href="#">kitaplar</a>
