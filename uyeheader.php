...
<div id="wrapper">
	<div id="container">
		...
		<div id="top">
			<h1 id="logo"><a href="/uyeekrani">kütüphane bilgi sistemi</a></h1>
			<div id="labels">
				<ul>
					<li><a href="#" class="user"><span class="bar">Hoşgeldiniz,<?=$users["adsoyad"]?></span></a></li>
			...
			<div id="menu">
				<ul> 
					<li class="current"><a href="/uyeekrani">Anasayfa</a></li> 
					...
					<li>
						<a href="#">Kitaplar</a>
						<ul> 
							<li><a href="/kitapistek">Kitap istek</a></li>
							<li><a href="/kitapayirtma">Kitap ayırtma</a></li>
							<li><a href="/kitapyorumlari">Kitap yorumları</a></li>
							<li><a href="/kitapteslimekle">Kitap teslim</a></li>
							<li><a href="/kitappuanlama">Kitap puanlama</a></li>
							<li><a href="/ekitap">E-Kitap</a></li>							
						</ul>
					</li>
					<li>
						<a href="#">sorgulama</a>
						<ul> 
							<li><a href="/kitaplarr">Baskı sorgulama</a></li>
							<li><a href="/kitaplarr">Kitap sorgulama</a></li>
							<li><a href="/kitaplarr">Tür sorgulama</a></li>
						</ul>
					</li>
					<li>
						<a href="#">iletişim</a>
						<ul> 
							<li><a href="/uyeyoltarifi">Yol tarifi</a></li>
							<li><a href="/uyeiletisim">İletişim</a></li>
						</ul>
					</li>
